...
export function FinanceDashboard() {
  ...
  return (
    <div className={`min-h-screen font-[system-ui] transition-colors duration-300 ${isDark ? 'bg-[#0a0a0f] text-gray-100' : 'bg-gray-50 text-gray-900'}`}>
      <div className={`absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] ${isDark ? 'from-emerald-900/20' : 'from-emerald-100/50'} via-transparent to-transparent pointer-events-none`} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold tracking-tight text-white">FinanceFlow</h1>
